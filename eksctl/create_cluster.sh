...
"${1}eksctl.sh" create nodegroup --cluster="dev-analytics-kube-${1}" --nodes=3 --name="dev-analytics-ng-devstats-${1}" --node-type=m5.2xlarge --node-labels "lfda=devstats,node=devstats" --version=1.13 --node-ami=auto --ssh-access
