...
"${1}h.sh" -n redis install redis stable/redis -f redis/custom.yaml --set "usePassword=false,master.nodeSelector.lfda=grimoire,master.persistence.storageClass=openebs-hostpath,master.persistence.size=4Gi,master.resources.requests.cpu=500m,master.resources.requests.memory=256Mi,master.resources.limits.cpu=4000m,master.resources.limits.memory=16Gi,slave.nodeSelector.lfda=grimoire,slave.persistence.storageClass=openebs-hostpath,slave.persistence.size=4Gi,slave.resources.requests.cpu=500m,slave.resources.requests.memory=256Mi,slave.resources.limits.cpu=4000m,slave.resources.limits.memory=16Gi"
